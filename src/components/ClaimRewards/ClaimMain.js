...
function ClaimRewards () {
    return (
        <div className='claim_section w-full h-full body bg-[#030015] flex flex-col justify-center items-center pb-36'>
          ...
          <button className="ml-7 text-xl mb-8 bg-gradient-to-br from-[#D8CEF9] to-[#A58ED7] hover:translate-y-[-10px] transition-transform duration-700 ease-in-out text-[#241357] font-medium py-3 px-10 rounded-md">
            Connect Wallet
          </button>
          <div className='flex flex-col items-center justify-center w-full mb-10 md:flex-row gap-7'>
            <div className='border border-gray-500 bg-[#161226] rounded-xl h-[150px] w-2/3 md:w-[220px] p-2'>
              <div className='border border-gray-500 bg-[#0c051e] rounded-xl h-full'>
                <button className="text-sm mt-4 bg-[#4D3B70] hover:cursor-auto text-white font-medium py-1 px-4 rounded-xl">
                  YOUR % OF CLAIM
                </button>
            ...
            <div className='border border-gray-500 bg-[#161226] rounded-xl h-[150px] w-2/3 md:w-[220px] p-2'>
              <div className='border border-gray-500 bg-[#0c051e] rounded-xl h-full'>
                <button className="w-[120px] text-sm max-w-md mt-4 bg-[#4D3B70] hover:cursor-auto text-white font-medium py-1 px-2 rounded-xl">
          ...
          <button className="md:text-xl text-lg ml-7 mb-12 bg-gradient-to-br from-[#D8CEF9] to-[#A58ED7] hover:translate-y-[-10px] transition-transform duration-700 ease-in-out text-[#241357] font-medium py-3 px-10 rounded-md">
            Claim Your ETH
          </button>
