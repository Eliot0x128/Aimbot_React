...
export default function Example() {
  return (
    <Disclosure as="nav" className="bg-[#030015]">
      {({ open }) => (
        <>
          <div className="px-2 py-2 first-letter:sm:px-6 lg:px-40">
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex items-center justify-center flex-1 sm:items-stretch sm:justify-between">
                ...
                <div className="hidden border border-[#9B83D031] bg-[#110A27] rounded-3xl px-4 sm:ml-6 sm:block">
